...
class CacheAnalyzerBackend extends AbstractBackend implements FreezableBackendInterface, PhpCapableBackendInterface, TaggableBackendInterface {
	...
	public function __construct($context, array $options = array()) {
		...
		parent::__construct($context, $options); // TODO: Change the autogenerated stub
	}
	 ...
	 */
	protected function setDatabaseEntry($calledMethod, $entryIdentifier = '', $data = '') {
	...
	public function set($entryIdentifier, $data, array $tags = array(), $lifetime = NULL) {
		$this->setDatabaseEntry('set', $entryIdentifier, $data);
	...
	public function get($entryIdentifier) {
		$this->setDatabaseEntry('get', $entryIdentifier);
	...
	public function has($entryIdentifier) {
		$this->setDatabaseEntry('has', $entryIdentifier);
	...
	public function remove($entryIdentifier) {
		$this->setDatabaseEntry('remove', $entryIdentifier);
	...
	public function isFrozen() {
		$this->setDatabaseEntry('isFrozen');
		if (is_callable(array(
			$this->originalBackend,
			'isFrozen'
		))
	...
	public function requireOnce($entryIdentifier) {
		$this->setDatabaseEntry('requireOnce', $entryIdentifier);
		if (is_callable(array(
			$this->originalBackend,
			'requireOnce'
		))
	...
	public function flushByTag($tag) {
		$this->setDatabaseEntry('flushByTag');
		if (is_callable(array(
			$this->originalBackend,
			'flushByTag'
		))
	...
	public function findIdentifiersByTag($tag) {
		$this->setDatabaseEntry('findIdentifiersByTag');
		if (is_callable(array(
			$this->originalBackend,
